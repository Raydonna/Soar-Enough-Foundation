/* ============================================================
   SOAR ENOUGH FOUNDATION — Shared Components
   Dynamically renders navbar + footer on every page
   ============================================================ */
...
const LOGO_SVG = '<img src="images/logo.png" alt="Logo" style="height:45px; filter: brightness(0) invert(1);">';
/* ---------- Navbar ---------- */
function renderNavbar() {
  const page = currentPage();
  const isActive = (p) => page === p ? 'active' : '';
  const isHome  = (page === 'index.html' || page === '') ? 'active' : '';
  ...
  document.body.insertAdjacentHTML('afterbegin', `
    ...
    <div class="mobile-overlay" id="mobileOverlay">
      ...
      <a href="contact.html" style="color:var(--orange-400);font-weight:700;">Donate</a>
    </div>
  `);
}
      ...
      <div class="container">
        <div class="footer-grid">
          <div>
            ...
            <p class="footer-about">We empower underrepresented youth through education, mentorship, and community-led development. Founded in 2024, driven by the belief that every young person deserves a fair start.</p>
          </div>
          <div>
            <h5>Navigate</h5>
          ...
          <div>
            <h5>Programs</h5>
            <ul class="footer-links">
              <li><a href="programs.html">Education Access</a></li>
              <li><a href="programs.html">Youth Mentorship</a></li>
              <li><a href="programs.html">Community Outreach</a></li>
              <li><a href="programs.html">Digital Futures</a></li>
            </ul>
          </div>
          <div class="footer-newsletter">
            <h5>Stay Connected</h5>
            <p>Get quarterly updates on our impact and upcoming events.</p>
        ...
        <div class="footer-bottom">
          <p>&copy; ${new Date().getFullYear()} Soar Enough Foundation. All rights reserved.</p>
